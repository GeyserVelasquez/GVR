...
<footer class="mt-9 bg-gray-50 max-sm:mt-10">
                ...
                <div>
                    ...
                    >
                        <div class="relative w-full">
                            ...
                            <button
                                type="submit"
                                class="absolute top-1.5 flex w-max items-center rounded-xl bg-gray-200 px-7 py-2.5 font-medium hover:bg-zinc-100 max-md:top-1 max-md:px-5 max-md:text-xs max-sm:mt-0 max-sm:rounded-lg max-sm:px-4 max-sm:py-2 ltr:right-2 rtl:left-2"
                            >
    ...
    <div class="flex justify-between bg-gray-100 px-[60px] py-3.5 max-md:justify-center max-sm:px-5">
        {!! view_render_event('bagisto.shop.layout.footer.footer_text.before') !!}

        <p class="mb-2 text-sm text-zinc-600 max-md:text-center">
            @lang('shop::app.components.layouts.footer.footer-text', ['current_year'=> date('Y') ])
        </p>

        <p class="text-sm text-zinc-600 max-md:text-center">
            <a href="https://instagram.com/holick.dev">Desarrolado por Holick</a>
        </p>
